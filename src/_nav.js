  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        to: '/administrativo/usuarios',
        icon: 'cilPeoplePlus',
      },
      {
        component: 'CNavItem',
        name: 'Servicios Personales',
        to: '/administrativo/servicios-personales',
        icon: 'cilPeoplePlus',
      },
      {
        component: 'CNavItem',
        name: 'Misión y Visión',
        to: '/administrativo/mision-vision',
        icon: 'cilInfo',
      },
      {
        component: 'CNavItem',
        name: 'Metas',
        to: '/administrativo/fp-meta-04',
        icon: 'cilList',
      },
      {
        component: 'CNavItem',
        name: 'Ayuntamiento',
        to: '/administrativo/ayuntamiento',
        icon: 'cilBuilding',
      },
    ],
  },
