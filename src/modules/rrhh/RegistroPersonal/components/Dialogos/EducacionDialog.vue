      ...
      <CCardBody>
        ...
        >
          ...
          <CCol :md="12">
            ...
            <CFormInput required id="courseName" v-model="education.courseName">
            </CFormInput>
            <CFormFeedback invalid> Favor agregar el campo </CFormFeedback>
          </CCol>
          ...
          <CCol :md="6">
            ...
            <CFormInput type="date" v-model="startDate" required id="startDate">
            </CFormInput>
            <CFormFeedback invalid> Favor agregar el campo </CFormFeedback>
          </CCol>
          <CCol :md="6">
...
export default {
  ...
  computed: {
    ...
    startDate: {
      ...
      set(value) {
        return (this.education.startDate = new Date(`${value}T00:00:00`))
      },
    },
    finishDate: {
      get() {
