			...
			fechaDesde: {
				get() {
					...
					if (
						...
						this.postAccionPersonal.fechaDesde?.toString() !==
							'Invalid Date'
					) {
						if (
							typeof this.postAccionPersonal.fechaDesde ===
							'string'
						) {
			...
			fechaHasta: {
				get() {
					...
					if (
						...
						this.postAccionPersonal.fechaHasta?.toString() !==
							'Invalid Date'
					) {
						if (
							typeof this.postAccionPersonal.fechaHasta ===
							'string'
						) {
		...
		methods: {
			...
			sendData() {
				...
				if (
					...
					return this.saveDataAccionPersonal({
