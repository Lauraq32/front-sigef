        ...
        <CModalBody>
            <CForm novalidate :validated="isFormEventTypeValidated" ref="eventTypeForm">
                <div class="d-flex flex-column justify-content-center gap-2">
                    ...
                    <div>
                        <label for="unidadMedida" class="font-weight-bold">Unidad Medida</label>
                        <CFormInput size="sm" id="unidadMedida" v-model="fpMetaDetalle.unidadMedida" required />
                    </div>
                    <div>
                        <label for="unidadMedida" class="font-weight-bold">Descripci&oacute;n</label>
                        <CFormTextarea rows="4" v-model="fpMetaDetalle.descripcion" required></CFormTextarea>
                    </div>
                </div>
            </CForm>
        </CModalBody>
