	...
	<div class="app">
		<div class="parent-div pb-4 text-center">
			...
			<div class="child-div mt-4">
				...
				<textarea
					class="form-control"
					v-model="propuestaDeclaratoria.mision"
					rows="3"
				></textarea>
			</div>
			<div class="child-div mt-4">
				...
				<textarea
					class="form-control"
					v-model="propuestaDeclaratoria.vision"
					rows="3"
				></textarea>
			</div>
			<div class="text-end mt-4">
				<button class="btn btn-info me-2" @click="putMisionVision()">
					Guardar
				</button>
				<button
					class="btn btn-secondary"
					@click="printReportMisionVision"
				>
					Imprimir
				</button>
			</div>
		...
		methods: {
			...
			putMisionVision() {
				if (this.propuestaDeclaratoria.id) {
					Api.putMisionVision(
						this.propuestaDeclaratoria.id,
						this.propuestaDeclaratoria,
					)
						.then(() => {
							this.show({
					...
					Api.postMisionVision(this.propuestaDeclaratoria)
						.then(() => {
							this.show({
