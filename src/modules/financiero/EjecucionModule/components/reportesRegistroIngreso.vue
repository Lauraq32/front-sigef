		...
		<CModalBody>
			...
			<div>
				<div v-if="datosImprimir.selectedOption == 'option1'">
					<div class="row">
						<div class="col-6">
							...
							<div>
								<CFormInput
									v-model="datosImprimir.fechaDesde"
									type="date"
								/>
							</div>
						</div>
						...
						<div class="col-6">
							...
							<div>
								<CFormInput
									v-model="datosImprimir.fechaHasta"
									type="date"
								/>
							</div>
						</div>
				...
				<div v-if="datosImprimir.selectedOption == 'option2'">
					<CFormLabel for="ctgClasificadorId"
