  ...
  <CModal backdrop="static" size="xl" :visible="showModal" @close="closeModal">
    ...
    <CModalBody>
        ...
        <CForm class="needs-validation" novalidate :validated="isFormEventTypeValidated" ref="eventTypeForm">
          <div class="row">
            <div class="col-6">
              <div class="row">
                <div class="col-6">
                  <CFormLabel for="codigoIngresoTalonario">No. de Recibo:</CFormLabel>
                  <CFormInput :maxlength="talonario" id="codigoIngresoTalonario"
            ...
            <div class="col-6">
              <div>
                <CFormLabel for="displayNameContribuyentes">Contribuyente</CFormLabel>
                <div class="position-relative">
                  <CFormInput required class="form-control padding-input" v-model="ingresoPost.contribuyente.nombre"
                    id="displayNameContribuyentes">
                  </CFormInput>
                  <span class="position-absolute icon-input" v-if="!notAllowEdit">
                    <CIcon icon="cisSearch" size="xl" v-on:click="() => (showContribuyentesModal = true)" />
                  </span>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <CFormSelect required v-model="ingresoPost.contribuyente.tipoDocumento" @change="changeDocument"
                    id="tipoDocumento">
                ...
                <div class="col-6">
                  ...
                  <CFormInput :maxlength="cedulaMax" v-on:keypress="checkDocument($event)" required
                    v-model="ingresoPost.contribuyente.documento" id="documento">
                  </CFormInput>
                  <CFormFeedback invalid>
                    Favor agregar el campo
                  </CFormFeedback>
              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <CFormInput v-model="ingresoPost.contribuyente.direccion" id="direccion">
                  </CFormInput>
                  <CFormFeedback invalid>
                    Favor agregar el campo
                  </CFormFeedback>
                ...
                <div class="col-6">
                  ...
                  <CFormInput class="form-control" v-model="ingresoPost.contribuyente.telefono" id="Teléfono"
                    @keypress="onlyNumber" />
                  <CFormFeedback invalid>
                    Favor agregar el campo
                  </CFormFeedback>
          ...
          <div class="mb-4">
            <CCol :md="12">
              ...
              <CFormTextarea style="resize: none" required v-model="ingresoPost.detalle" id="Detalle"></CFormTextarea>
              <CFormFeedback invalid> Campo requerido</CFormFeedback>
            </CCol>
          </div>
        </CForm>

        <CForm class="needs-validation" novalidate :validated="isFormEventTypeValidatedDetalle"
          ref="eventTypeFormDetalle">
          <div class="border-top pt-3">
            <div class="row">
              <div class="col-12 row align-items-center my-2">
                <CFormLabel for="ctgClasificadorId" class="col-1 col-form-label">Clasificador:</CFormLabel>
                <div class="col-2">
                  <div class="position-relative">
          ...
          <div class="row border-bottom mb-3">
            <div class="col-12 row align-items-center my-2">
              <CFormLabel for="Monto" class="col-1 col-form-label">Monto:</CFormLabel>
              <div class="col-2">
                <CurrencyInput class="form-control text-end" required id="presupuestoBco1" v-model="detallePost.valor"
                  :options="{
                    locale: 'en-US',
                    currency: 'USD',
                    precision: 2,
                ...
                <CFormFeedback invalid :style="{ display: validacionMonto ? 'flex' : 'none' }">
                  El monto no puede ser igual a 0
                </CFormFeedback>
              </div>

              <CFormLabel for="Cantidad" class="col-1 col-form-label">Cantidad:</CFormLabel>
              <div class="col-1">
                <div class="col-md-12">
                  <VueNumberFormat id="Cantidad" required v-model:value="detallePost.cantidad"
              ...
              <div class="col-3 d-flex justify-content-end">
                <CButton type="button" class="mt-1" color="info" variant="outline" @click="addDetalle">
                  Agregar
                </CButton>
              </div>
            </div>
      ...
      <CSmartTable clickableRows :tableProps="{
        striped: true,
        hover: true,
      }" :tableHeadProps="{}" :activePage="1" header :items="ingresoPost.detalleRegistroIngresos" :columns="columns"
        :footer="footerItem" columnFilter :itemsPerPage="5" columnSorter no-items-label="No hay registros"
...
import contribuyentesDialog from './ModalSelectContribuyentes.vue'
