            ...
            >
              ...
              <CCol :md="2">
                <CButton
                  ...
                  style="font-weight: bold"
                  color="info"
                  @click="setValueButtonGasto(40, 9992, 120)"
                >
                  40/9992/120</CButton
                >
              </CCol>
              ...
              <CCol :md="2">
                <CButton
                  @click="
                    () => {
                      disabledClasificador = false
                    }
                  "
                  class="btn-sm"
                  :disabled="idDetalle != null ? true : false"
                  style="font-weight: bold"
                  color="info"
  ...
  methods: {
    ...
    guardarDetalleGasto() {
      if (this.idDetalle != null) {
        this.detallePost.presupuestoBco1 = parseInt(this.detallePost.oriBco1)
        this.detallePost.presupuestoBco2 = parseInt(this.detallePost.oriBco2)
        this.detallePost.presupuestoBco3 = parseInt(this.detallePost.oriBco3)
        this.detallePost.presupuestoBco4 = parseInt(this.detallePost.oriBco4)
