							...
							<div class="col-4 border p-3">
								...
								<CCol :md="12" class="mt-2">
									...
									<CFormSelect
										disabled
										v-model="
											postGenerarNomina.programaDivisionId
										"
										id="validationCustom05"
									>
										<option
                  ...
                  /> -->
							...
							<div class="col-2">
								...
								<CCol>
									...
									<CFormInput
										v-model="
											postEmpleado.impuestoSobreRenta
										"
										id="validationCustom02"
										required
									/>
                      ...
                      <a @click.prevent="deleteField(index, prueba)" href="">
                        ...
                        />
								...
								<CCol :md="18">
									...
									<CFormInput
										v-model="
											postConfiguracionNomina.retencion1Id
										"
										class="mt-2"
										id="validationCustom02"
										required
								...
								<CCol :md="18">
									...
									<CFormInput
										v-model="
											postConfiguracionNomina.retencion2Id
										"
										class="mt-2"
										id="validationCustom02"
										required
								...
								<CCol :md="18">
									...
									<CFormInput
										v-model="
											postConfiguracionNomina.retencion3Id
										"
										class="mt-2"
										id="validationCustom02"
										required
								...
								<CCol :md="18">
									...
									<CFormInput
										v-model="
											postConfiguracionNomina.retencion4Id
										"
										class="mt-2"
										id="validationCustom02"
										required
								...
								<CCol :md="18">
									...
									<CFormInput
										v-model="
											postConfiguracionNomina.retencion5Id
										"
										class="mt-2"
										id="validationCustom02"
										required
								...
								<CCol :md="18">
									...
									<CFormInput
										v-model="
											postConfiguracionNomina.retencion6Id
										"
										class="mt-2"
										id="validationCustom02"
										required
								...
								<CCol :md="18">
									...
									<CFormInput
										v-model="
											postConfiguracionNomina.retencion7Id
										"
										class="mt-2"
										id="validationCustom02"
										required
								...
								<CCol :md="18">
									...
									<CFormInput
										v-model="
											postConfiguracionNomina.retencion8Id
										"
										class="mt-2"
										id="validationCustom02"
										required
								...
								<CCol :md="18">
									...
									<CFormInput
										v-model="
											postConfiguracionNomina.retencion9Id
										"
										class="mt-2"
										id="validationCustom02"
										required
								...
								<CCol :md="18">
									...
									<CFormInput
										v-model="
											postConfiguracionNomina.retencion10Id
										"
										class="mt-2"
										id="validationCustom02"
										required
						...
						<div class="row">
							...
							<div class="col-4 border">
								...
								<CCol>
									...
									<CFormInput
										disabled
										v-model="ingresos.cantidadIngreso"
										type="number"
										id="validationCustom02"
										required
									/>
						...
						<div class="col-7">
							<div class="col-11">
								<CCol>
									...
									<CFormSelect
										v-model="
											postGenerarNomina.ProgramaDivision
										"
										id="validationCustom05"
							...
							<div class="col-11">
								<CCol>
									...
									<CFormSelect
										v-model="
											postGenerarNomina.DepartamentoId
										"
										id="validationCustom05"
							...
							<div>
								<CCol :md="4">
									...
									<CFormInput
										type="date"
										v-model="postGenerarNomina.fecha"
										id="validationCustom01"
										required
									/>
							...
							<div class="mt-5">
								...
								<div class="mt-3">
									<button
										...
										class="btn btn-outline-dark"
									>
										Emp. con descuento MAYOR a % del sueldo,
										segun Ley
									</button>
								</div>
							</div>
						...
						<div class="col-5">
							...
							<CTabContent class="border p-3">
									...
									<div class="row">
										<CCol :md="6">
											<div>
												...
												<CFormInput
													disabled
													v-model="
														postConfiguracionNomina.textoEgr1
													"
													id="validationCustom01"
													required
													value="Imp/Renta"
										...
										<CCol :md="3">
											...
											<CFormInput
												type="number"
												v-model="
													postConfiguracionNomina.factorDivicionEg01
												"
												id="validationCustom01"
												required
											/>
									...
									<div class="row">
										<CCol :md="6">
											<div>
												...
												<CFormInput
													...
													disabled
													v-model="
														postConfiguracionNomina.textoEgr2
													"
													id="validationCustom01"
													required
												/>
										...
										<CCol :md="3">
											...
											<CFormInput
												type="number"
												v-model="
													postConfiguracionNomina.factorDivicionEg02
												"
												id="validationCustom01"
												required
											/>
									...
									<div class="row">
										<CCol :md="6">
											<div>
												...
												<CFormInput
													...
													disabled
													v-model="
														postConfiguracionNomina.textoEgr3
													"
													id="validationCustom01"
													required
												/>
										...
										<CCol :md="3">
											...
											<CFormInput
												type="number"
												v-model="
													postConfiguracionNomina.factorDivicionEg03
												"
												id="validationCustom01"
												required
											/>
									...
									<div class="row">
										<CCol :md="6">
											<div>
												...
												<CFormInput
													v-model="
														postConfiguracionNomina.textoEgr4
													"
													id="validationCustom01"
													required
												/>
										...
										<CCol :md="3">
											...
											<CFormInput
												type="number"
												v-model="
													postConfiguracionNomina.factorDivicionEg04
												"
												id="validationCustom01"
												required
											/>
									...
									<div class="row">
										<CCol :md="6">
											<div>
												...
												<CFormInput
													v-model="
														postConfiguracionNomina.textoEgr5
													"
													id="validationCustom01"
													required
												/>
										...
										<CCol :md="3">
											...
											<CFormInput
												type="number"
												v-model="
													postConfiguracionNomina.factorDivicionEg05
												"
												id="validationCustom01"
												required
											/>
									...
									<div class="row">
										<CCol :md="6">
											<div>
												...
												<CFormInput
													v-model="
														postConfiguracionNomina.textoEgr6
													"
													id="validationCustom01"
													required
												/>
										...
										<CCol :md="3">
											...
											<CFormInput
												type="number"
												v-model="
													postConfiguracionNomina.factorDivicionEg06
												"
												id="validationCustom01"
												required
											/>
									...
									<div class="row">
										<CCol :md="6">
											<div>
												...
												<CFormInput
													v-model="
														postConfiguracionNomina.textoEgr7
													"
													id="validationCustom01"
													required
												/>
										...
										<CCol :md="3">
											...
											<CFormInput
												type="number"
												v-model="
													postConfiguracionNomina.factorDivicionEg07
												"
												id="validationCustom01"
												required
											/>
									...
									<div class="row">
										<CCol :md="6">
											<div>
												...
												<CFormInput
													v-model="
														postConfiguracionNomina.textoEgr8
													"
													id="validationCustom01"
													required
												/>
										...
										<CCol :md="3">
											...
											<CFormInput
												type="number"
												v-model="
													postConfiguracionNomina.factorDivicionEg08
												"
												id="validationCustom01"
												required
											/>
									...
									<div class="row">
										<CCol :md="6">
											<div>
												...
												<CFormInput
													v-model="
														postConfiguracionNomina.textoEgr9
													"
													id="validationCustom01"
													required
												/>
										...
										<CCol :md="3">
											...
											<CFormInput
												type="number"
												v-model="
													postConfiguracionNomina.factorDivicionEg09
												"
												id="validationCustom01"
												required
											/>
									...
									<div class="row">
										<CCol :md="6">
											<div>
												...
												<CFormInput
													v-model="
														postConfiguracionNomina.textoEgr10
													"
													id="validationCustom01"
													required
												/>
										...
										<CCol :md="3">
											...
											<CFormInput
												type="number"
												v-model="
													postConfiguracionNomina.factorDivicionEg010
												"
												id="validationCustom01"
												required
											/>
								...
								>
									...
									squid. Exercitation +1 labore velit,
								</CTabPane>
							</CTabContent>
						</div>
					</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			clearModal1() {
				Api.getProgramaDivision().then((response) => {
					...
					this.postGenerarNomina.ProgramaDivision =
						this.programaDivision[0].id;

					Api.getDepartamentoByProgramaId(
						this.programaDivision[0].id,
					).then((response) => {
						this.departamentos = response.data.data;
						this.postGenerarNomina.DepartamentoId =
							this.departamentos[0].id;
					});
				});
			},
			...
			changePrograma(e) {
				Api.getDepartamentoByProgramaId(e.target.value).then(
					(response) => {
						this.departamentos = response.data.data;
					},
				);
			...
			klk() {
				Api.getDepartamentoById(this.departamentos[0].id).then(
					(response) => {
						this.clasificador =
							response.data.data.ctgClasificadorId;
			...
			formatFecha() {
				return moment(this.fecha12).format('YYYY-MM-DD');
			},
			...
			submitForm() {
				if (this.id) {
					Api.putEmpleado(this.id, this.postEmpleado).then(() => {
						this.lgDemo = false;
						this.show({
			...
			toggleDetails(item) {
				if (
					item.postConfiguracionNomina !== 0 ||
					item.variacion !== 0
				) {
