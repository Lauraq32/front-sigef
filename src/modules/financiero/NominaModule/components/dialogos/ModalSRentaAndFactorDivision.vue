<template>
  <CModal backdrop="static" size="lg" :visible="showModal" @close="closeModal">
    <CModalHeader>
      <CModalTitle
        >Configuración de Impuesto Sobre la Renta/ Factor de
        División.</CModalTitle
      >
    </CModalHeader>
    ...
    <CModalBody>
      <CCardBody>
        <CCardTitle class="mx-5 pb-4 d-flex justify-content-center">
          <h6>Escala de Sueldos para Calculo del Impuesto Sobre la Renta</h6>
        </CCardTitle>
        <CForm>
          <div class="row">
            <div class="col-md-5">
