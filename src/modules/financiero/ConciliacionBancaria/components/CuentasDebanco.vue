    ...
    <CModalBody>
      <CCardBody>
        ...
        >
          ...
          <CCol :md="4">
            <CFormLabel for="validationCustom02">Catalogo</CFormLabel>
          ...
          <CCol :md="3">
            <CFormLabel for="validationCustom04">Número Cta:</CFormLabel >
          ...
          <hr/>
          <h1>Departamento de contabilidad</h1>
          <CCol :md="3">
            <CFormLabel for="validationCustom05"
              >Nombre de Cuenta:</CFormLabel
            >
            <CFormInput id="validationCustom05" required />
            <CFormFeedback invalid> Favor agregar el campo </CFormFeedback>
          </CCol>
          ...
          <CCol :md="3">
            <CFormLabel for="validationCustom05"
              >Ultimo número físico:</CFormLabel
            >
            <CFormInput id="validationCustom05" required />
            <CFormFeedback invalid> Favor agregar el campo </CFormFeedback>
          </CCol>
