<template>
  <h3 class="text-center">Notas de crédito</h3>
  <hr />
  <div>
  ...
  >
    <CModalHeader>
      <CModalTitle>Formulario cuentas de crédito</CModalTitle>
    </CModalHeader>
    <CModalBody>
      <CCardBody>
        <CForm
  ...
  data: () => {
    return {
      ...
      columns: [
        ...
        { key: 'Tipo transacción', label: 'Tipo transacción', _style: { width: '40%' } },
        { key: 'Detalle', label: 'Detalle', _style: { width: '40%' } },
        { key: 'Secuencial', label: 'Secuencial', _style: { width: '40%' } },
        {
          key: 'show_details',
          label: '',
          _style: { width: '1%' },
